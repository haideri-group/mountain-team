...
export type WorkflowStage = "backlog" | "todo" | "on_hold" | "in_progress" | "in_review" | "ready_for_testing" | "ready_for_live" | "rolling_out" | "post_live_testing" | "done" | "closed";
export type IssueStatus = WorkflowStage; // backward compat

export const WORKFLOW_STAGES: WorkflowStage[] = [
  "backlog", "todo", "on_hold", "in_progress", "in_review", "ready_for_testing",
  "ready_for_live", "rolling_out", "post_live_testing", "done", "closed",
];
